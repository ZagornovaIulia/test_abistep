...
from app.storage import users, users_lock
...
async def transfer_money(transfer: Transfer) -> TransferResult:
    """
    Перевод средств от одного пользователя другому.

    returns: TransferResult: Результат перевода с обновлёнными балансами.
    """
